...
Requires: varnish >= 9.0.0
BuildRequires: make, python-docutils, varnish >= 9.0.0, varnish-devel >= 9.0.0
...
%changelog
* Tue Mar 17 2026 Carlos Abalde <carlos.abalde@gmail.com> - 18.0-1.20260317
