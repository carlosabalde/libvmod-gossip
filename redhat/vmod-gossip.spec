...
Requires: varnish >= 7.1.0
BuildRequires: make, python-docutils, varnish >= 7.1.0, varnish-devel >= 7.1.0
...
%changelog
* Tue Mar 15 2022 Carlos Abalde <carlos.abalde@gmail.com> - 10.0-1.20210315
